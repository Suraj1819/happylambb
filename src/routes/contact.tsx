...
// const field =
//   "mt-1.5 w-full rounded-lg border border-border/40 dark:border-zinc-700 bg-surface/30 dark:bg-zinc-900/50 px-4 py-3 text-sm outline-none transition-all duration-200 placeholder:text-muted-foreground/40 dark:placeholder:text-zinc-600 focus:border-foreground/30 dark:focus:border-zinc-500 focus:bg-background dark:focus:bg-zinc-950 focus:ring-1 focus:ring-foreground/10 dark:focus:ring-zinc-500";
...
//         <span className="font-semibold text-foreground dark:text-white">Thanks {name}!</span>
//       </div>
//       <p className="text-sm text-muted-foreground dark:text-zinc-400">
//         We'll reply within one working day from our <span className="font-medium text-foreground dark:text-white">{studio}</span> studio.
//       </p>
//       <div className="mt-1 flex items-center gap-2 text-xs text-muted-foreground/60 dark:text-zinc-500">
//         <Sparkles className="h-3 w-3 text-muted-foreground/60 dark:text-zinc-500" />
...
//       duration: 5000,
//       position: "top-center",
//       className: "!bg-background !border !border-border/40 !shadow-2xl !shadow-border/10 !rounded-2xl !p-4 dark:!bg-zinc-950 dark:!border-zinc-800",
//       icon: <CheckCircle className="h-5 w-5 text-muted-foreground/60 dark:text-zinc-500" />,
//     }
//   );
// };
...
//           <Reveal>
//             <div className="rounded-2xl border border-border/40 dark:border-zinc-800 bg-surface/30 dark:bg-zinc-900/50 p-6 sm:p-8 shadow-sm">
//               <form onSubmit={handleSubmit(onSubmit)} className="grid gap-5 sm:grid-cols-2">
//                 <div>
//                   <label className="text-xs font-medium uppercase tracking-wider text-muted-foreground dark:text-zinc-400">
//                     Name
//                   </label>
//                   <input {...register("name")} className={field} placeholder="Full name" />
//                   {errors.name && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.name.message}</p>
//                   )}
//                 </div>
...
//                   {errors.phone && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.phone.message}</p>
//                   )}
//                 </div>
...
//                   {errors.email && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.email.message}</p>
//                   )}
//                 </div>
...
//                   {errors.company && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.company.message}</p>
//                   )}
//                 </div>
...
//                   </select>
//                   {errors.service && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.service.message}</p>
//                   )}
//                 </div>
...
//                   </select>
//                   {errors.studio && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.studio.message}</p>
//                   )}
//                 </div>
...
//                   </select>
//                   {errors.budget && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.budget.message}</p>
//                   )}
//                 </div>
...
//                   />
//                   {errors.message && (
//                     <p className="mt-1 text-xs text-destructive dark:text-red-400">{errors.message.message}</p>
//                   )}
//                 </div>
...
//                     className="w-full rounded-lg bg-ink py-3.5 text-sm font-medium tracking-wide text-ink-foreground dark:bg-white dark:text-zinc-950 transition hover:bg-ink/80 dark:hover:bg-zinc-200 disabled:opacity-60 sm:w-auto sm:px-10"
//                   >
...
//           {/* Right: Studios (Professional Gray Cards) */}
//           <Reveal delay={0.08} className="space-y-6">
//             {STUDIOS.map((s) => (
//               <div
//                 key={s.city}
//                 className="overflow-hidden rounded-2xl border border-border/40 dark:border-zinc-800 bg-surface/30 dark:bg-zinc-900/50 shadow-sm"
//               >
//                 {/* Map */}
...
//                       className="flex gap-3 transition hover:text-foreground dark:hover:text-white"
//                     >
...
//                     <a
//                       href={`tel:${s.phoneRaw}`}
//                       className="flex items-center gap-3 transition hover:text-foreground dark:hover:text-white"
//                     >
...
//                     <a
//                       href={`mailto:${s.email}`}
//                       className="flex items-center gap-3 break-all transition hover:text-foreground dark:hover:text-white"
//                     >
...
//                   {/* 🟢 FIX: Green Color Removed - Made Premium Gray */}
//                   <a
//                     href={`https://wa.me/${s.whatsapp}`}
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg bg-muted-foreground/20 dark:bg-zinc-700/40 py-2.5 text-xs font-medium text-foreground dark:text-white transition hover:bg-muted-foreground/30 dark:hover:bg-zinc-600/60 hover:shadow-sm"
//                   >
