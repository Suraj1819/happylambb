    ...
    <>
        ...
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10 w-full">
          <Reveal>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <p className="text-xs tracking-[0.3em] text-foreground/60 dark:text-zinc-400 uppercase font-medium">Our Team</p>
            </div>
            ...
            <h1 className="text-[clamp(3rem,7.5vw,5.5rem)] leading-[0.95] tracking-tighter font-medium text-foreground dark:text-white max-w-4xl">
              The crew behind <br />
              <span className="italic text-muted-foreground/60 dark:text-zinc-400">every frame.</span>
            </h1>
          </Reveal>
        </div>
      </section>
      ...
      <section className="py-12 bg-background dark:bg-zinc-950">
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
          <Reveal delay={0.1} className="overflow-hidden rounded-xl border border-border/40 dark:border-zinc-800 shadow-sm">
            <img
              src={teamGroup}
                ...
                >
                  ...
                  >
                    ...
                    <div className={lead ? "max-w-xl sm:mt-0" : "mt-6"}>
                      {/* FULL NAME */}
                      <h2 className={`font-medium tracking-tight text-foreground dark:text-white ${lead ? "text-4xl sm:text-5xl" : "text-3xl"}`}>
                        {member.name}
                      </h2>
                      ...
                      {/* BIO */}
                      <p className={`mt-4 leading-relaxed italic text-muted-foreground/80 dark:text-zinc-400 ${lead ? "text-base" : "text-sm"}`}>
                        {member.bio}
                      </p>
                    </div>
                  </article>
        ...
        <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
          <Reveal className="mb-16 text-center">
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <p className="text-xs tracking-[0.2em] text-muted-foreground dark:text-zinc-400 uppercase">Internship Program</p>
              <div className="h-px w-6 bg-border dark:bg-zinc-700"></div>
            </div>
            <h2 className="text-4xl md:text-5xl font-medium tracking-tight text-foreground dark:text-white">
              Future talent <br />
              <span className="italic text-muted-foreground/60 dark:text-zinc-400">in the making.</span>
            </h2>
                      ...
                      <div className="mt-4 pt-4 border-t border-border/30 dark:border-zinc-800">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] text-muted-foreground/60 dark:text-zinc-500">
                            {intern.duration || "6 months"} • Mentored by {intern.mentor || "Core Team"}
                          </span>
                        </div>
                      </div>
                    </div>
        ...
        <div className="mx-auto grid max-w-[1400px] gap-10 px-6 sm:px-10 lg:grid-cols-[0.8fr_1.2fr]">
          <Reveal>
            <div className="flex items-center gap-4 mb-4">
              <div className="h-px w-6 bg-border dark:bg-zinc-700"></div>
              <p className="text-xs tracking-[0.2em] text-muted-foreground dark:text-zinc-400 uppercase">Culture</p>
            </div>
            <h2 className="text-4xl md:text-5xl font-medium tracking-tight text-foreground dark:text-white">How we work together.</h2>
          </Reveal>
