...
const SOCIALS = [
  { icon: InstagramIcon, href: "https://www.instagram.com/happylambproduction", label: "Instagram" },
  { icon: LinkedinIcon, href: "https://www.linkedin.com/in/ankit-kumar-1b9666313?utm_source=share_via&utm_content=profile&utm_medium=member_android", label: "LinkedIn" },
